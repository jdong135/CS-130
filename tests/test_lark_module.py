...
class Lark_Module_Basic(unittest.TestCase):
    ...
    def test_div_zero1(self):
        ...
        assert value.get_type() == cell_error.CellErrorType.DIVIDE_BY_ZERO
    ...
    def test_string_arithmetic1(self):
        ...
        value = wb.get_cell_value('sheet1', 'A3')
        assert isinstance(value, cell_error.CellError)
        assert value.get_type() == cell_error.CellErrorType.TYPE_ERROR
    ...
    def test_bad_reference1(self):
        ...
        assert isinstance(value, cell_error.CellError)
        assert value.get_type() == cell_error.CellErrorType.BAD_REFERENCE
    ...
    def test_parse_error1(self):
        ...
        value = wb.get_cell_value('sheet1', 'A1')
        assert isinstance(value, cell_error.CellError)
        assert value.get_type() == cell_error.CellErrorType.PARSE_ERROR
